...
// file taken from https://github.com/rancher/rke/blob/master/vendor/github.com/rancher/types/apis/management.cattle.io/v3/rke_types.go
// haven't vendored it as it has dependencies like k8s.io etc...
// I have also added a couple more structs to make the file self contained
// Also added omit Empty for yaml fields to reduce config yaml size
...
type RancherKubernetesEngineConfig struct {
	...
	AddonJobTimeout int `yaml:"addon_job_timeout,omitempty" json:"addonJobTimeout,omitempty" norman:"default=30"`
	...
	*RotateCertificates `yaml:"rotate_certificates,omitempty" json:"rotateCertificates,omitempty"`
	// DNS Config
...
type RKEConfigNode struct {
	...
	// SSH Agent Auth enable
	SSHAgentAuth bool `yaml:"ssh_agent_auth,omitempty,omitempty" json:"sshAgentAuth,omitempty"`
	// SSH Private Key
	SSHKey string `yaml:"ssh_key,omitempty" json:"sshKey,omitempty" norman:"type=password"`
	// SSH Private Key Path
	SSHKeyPath string `yaml:"ssh_key_path,omitempty" json:"sshKeyPath,omitempty"`
...
type DNSConfig struct {
	// DNS provider
	Provider string `yaml:"provider,omitempty" json:"provider,omitempty" norman:"default=kube-dns"`
...
type BackupConfig struct {
	...
	Enabled *bool `yaml:"enabled,omitempty" json:"enabled,omitempty" norman:"default=true"`
	// Backup interval in hours
	IntervalHours int `yaml:"interval_hours,omitempty" json:"intervalHours,omitempty" norman:"default=12"`
	// Number of backups to keep
	Retention int `yaml:"retention,omitempty" json:"retention,omitempty" norman:"default=6"`
	// s3 target
...
type S3BackupConfig struct {
	// Access key ID
	AccessKey string `yaml:"access_key,omitempty" json:"accessKey,omitempty"`
	// Secret access key
	SecretKey string `yaml:"secret_key,omitempty" json:"secretKey,omitempty" norman:"required,type=password" `
	// name of the bucket to use for backup
	BucketName string `yaml:"bucket_name,omitempty" json:"bucketName,omitempty"`
